...
class GlyphCellWidget(QWidget):
    ...
    *orderChanged*).
    ...
    def setGlyphs(self, glyphs):
        ...
        newSelection = set([glyphs.index(
            glyph) for glyph in currentSelection if glyph in glyphs])
        self._glyphs = glyphs
    ...
    def scrollToCell(self, index):
        ...
        x = (.5 + index % self._columnCount) * cellWidth
        y = (.5 + index // self._columnCount) * cellHeight
